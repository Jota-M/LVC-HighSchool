...
import { usePeriodosVacacionales, useCursosVacacionales, useInscripcionesVacacionales } from '@/hooks/useCursosVacacionales';
...
export const InscripcionesTable: React.FC<InscripcionesTableProps> = ({
  ...
  // Hooks para obtener datos de filtros
  ...
  const handleCambiarEstado = (inscripcionId: number, estado: EstadoInscripcionVacacional, e: React.MouseEvent) => {
    e.stopPropagation();
    cambiarEstado({ id: inscripcionId, data: { estado } });
  };
