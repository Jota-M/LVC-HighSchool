    ...
    <LocalizationProvider dateAdapter={AdapterDayjs}>
      ...
      >
        ...
        >
          ...
          >
            Ingresa los datos de tu solicitud para verificar el estado actual 
          </Typography>
        </Grid>
        ...
        >
          ...
          >
            Verificar estado de Preinscripcion
          </Typography>
          <Typography
            variant="body2"
            sx={{
          ...
          <FormGroup sx={{display:'flex', flexDirection:'row', gap:"2em",margin:3}}>
            ...
            <TextField sx={{width:{ xs: '100%', sm: '80%', md: '100%', lg: '100%' }}} variant='outlined' label='Número de referencia' />
            <TextField sx={{width:{ xs: '100%', sm: '80%', md: '45%', lg: '48%' }}} variant='outlined' label='Número de carnet' />
            <DatePicker
              sx={{ width:{ xs: '100%', sm: '80%', md: '45%', lg: '%48' }}}
