    ...
    >
      ...
      >
        ...
        <Chip
          ...
          label="INSCRIPCIONES ABIERTAS 2026"
          color="primary"
          sx={{
            fontWeight: "bold",
            fontSize: "0.85rem",
        ...
        >
          Inscripciones abiertas para el año lectivo 2026. Completa el
        ...
        >
          {[
            { label: "Plataforma virtual", value: "24/7", icon: <TrendingUpIcon />, color: "#01579b" },
            { label: "Tasa de aprobación", value: "98%", icon: <CheckCircleIcon />, color: "#4caf50" },
            { label: "Niveles Educativos", value: "3", icon: <AutoAwesomeIcon />, color: "#ff9800" },
          ].map((stat, i) => (
            <Box
              key={i}
              sx={{
