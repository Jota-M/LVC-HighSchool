...
const FloatingPreinscripcionButton = () => {
    ...
    >
      <button
        ...
        className={`group relative overflow-hidden 
          ...
          rounded-2xl shadow-xl hover:shadow-indigo-500/30 dark:hover:shadow-indigo-400/30 
...
export default FloatingPreinscripcionButton;
